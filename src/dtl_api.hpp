...
#define UPDATE_CONFIG_PHYSMAP(base, config, maxConfigs, EphemeralConfigPhysStart) (WRITE_UINT64((uint64_t)base+(config*0x8)+(2*maxConfigs*0x8)+0x400, EphemeralConfigPhysStart))
